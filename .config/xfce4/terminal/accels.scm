...
;	TABs
;
(gtk_accel_path "<Actions>/terminal-window/new-tab" "<Shift>Down")
...
(gtk_accel_path "<Actions>/terminal-window/tabs-menu" "<Shift>Up")
; (gtk_accel_path "<Actions>/terminal-window/set-title" "<Shift>Up")
...
;	Move-to TAB
;
(gtk_accel_path "<Actions>/terminal-window/goto-tab-1" "<Alt><Shift>1")
(gtk_accel_path "<Actions>/terminal-window/goto-tab-2" "<Alt><Shift>2")
(gtk_accel_path "<Actions>/terminal-window/goto-tab-3" "<Alt><Shift>3")
(gtk_accel_path "<Actions>/terminal-window/goto-tab-4" "<Alt><Shift>4")
(gtk_accel_path "<Actions>/terminal-window/goto-tab-5" "<Alt><Shift>5")
(gtk_accel_path "<Actions>/terminal-window/goto-tab-6" "<Alt><Shift>6")
(gtk_accel_path "<Actions>/terminal-window/goto-tab-7" "<Alt><Shift>7")
(gtk_accel_path "<Actions>/terminal-window/goto-tab-8" "<Alt><Shift>8")
(gtk_accel_path "<Actions>/terminal-window/goto-tab-9" "<Alt><Shift>9")
;
;	Zoom
;
...
;	OTHER
;
(gtk_accel_path "<Actions>/terminal-window/show-borders" "<Primary><Shift>F1")
